...
typedef void (APIENTRY PFNGLDEBUGMESSAGECALLBACKKHR_PROC (GLDEBUGPROCKHR callback, const void * userParam));
...
typedef void (APIENTRY PFNGLDEBUGMESSAGECONTROLKHR_PROC (GLenum source, GLenum type, GLenum severity, GLsizei count, const GLuint * ids, GLboolean enabled));
...
typedef void (APIENTRY PFNGLDEBUGMESSAGEINSERTKHR_PROC (GLenum source, GLenum type, GLuint id, GLenum severity, GLsizei length, const GLchar * buf));
...
typedef GLuint (APIENTRY PFNGLGETDEBUGMESSAGELOGKHR_PROC (GLuint count, GLsizei bufSize, GLenum * sources, GLenum * types, GLuint * ids, GLenum * severities, GLsizei * lengths, GLchar * messageLog));
typedef void (APIENTRY PFNGLGETOBJECTLABEL_PROC (GLenum identifier, GLuint name, GLsizei bufSize, GLsizei * length, GLchar * label));
typedef void (APIENTRY PFNGLGETOBJECTLABELKHR_PROC (GLenum identifier, GLuint name, GLsizei bufSize, GLsizei * length, GLchar * label));
typedef void (APIENTRY PFNGLGETOBJECTPTRLABEL_PROC (const void * ptr, GLsizei bufSize, GLsizei * length, GLchar * label));
typedef void (APIENTRY PFNGLGETOBJECTPTRLABELKHR_PROC (const void * ptr, GLsizei bufSize, GLsizei * length, GLchar * label));
typedef void (APIENTRY PFNGLGETPOINTERV_PROC (GLenum pname, void ** params));
typedef void (APIENTRY PFNGLGETPOINTERVKHR_PROC (GLenum pname, void ** params));
typedef void (APIENTRY PFNGLOBJECTLABEL_PROC (GLenum identifier, GLuint name, GLsizei length, const GLchar * label));
typedef void (APIENTRY PFNGLOBJECTLABELKHR_PROC (GLenum identifier, GLuint name, GLsizei length, const GLchar * label));
typedef void (APIENTRY PFNGLOBJECTPTRLABEL_PROC (const void * ptr, GLsizei length, const GLchar * label));
typedef void (APIENTRY PFNGLOBJECTPTRLABELKHR_PROC (const void * ptr, GLsizei length, const GLchar * label));
typedef void (APIENTRY PFNGLPOPDEBUGGROUP_PROC (void));
typedef void (APIENTRY PFNGLPOPDEBUGGROUPKHR_PROC (void));
typedef void (APIENTRY PFNGLPUSHDEBUGGROUP_PROC (GLenum source, GLuint id, GLsizei length, const GLchar * message));
typedef void (APIENTRY PFNGLPUSHDEBUGGROUPKHR_PROC (GLenum source, GLuint id, GLsizei length, const GLchar * message));

GLAPI PFNGLDEBUGMESSAGECALLBACK_PROC *glpfDebugMessageCallback;
GLAPI PFNGLDEBUGMESSAGECALLBACKKHR_PROC *glpfDebugMessageCallbackKHR;
GLAPI PFNGLDEBUGMESSAGECONTROL_PROC *glpfDebugMessageControl;
GLAPI PFNGLDEBUGMESSAGECONTROLKHR_PROC *glpfDebugMessageControlKHR;
GLAPI PFNGLDEBUGMESSAGEINSERT_PROC *glpfDebugMessageInsert;
GLAPI PFNGLDEBUGMESSAGEINSERTKHR_PROC *glpfDebugMessageInsertKHR;
GLAPI PFNGLGETDEBUGMESSAGELOG_PROC *glpfGetDebugMessageLog;
GLAPI PFNGLGETDEBUGMESSAGELOGKHR_PROC *glpfGetDebugMessageLogKHR;
GLAPI PFNGLGETOBJECTLABEL_PROC *glpfGetObjectLabel;
GLAPI PFNGLGETOBJECTLABELKHR_PROC *glpfGetObjectLabelKHR;
GLAPI PFNGLGETOBJECTPTRLABEL_PROC *glpfGetObjectPtrLabel;
GLAPI PFNGLGETOBJECTPTRLABELKHR_PROC *glpfGetObjectPtrLabelKHR;
GLAPI PFNGLGETPOINTERV_PROC *glpfGetPointerv;
GLAPI PFNGLGETPOINTERVKHR_PROC *glpfGetPointervKHR;
GLAPI PFNGLOBJECTLABEL_PROC *glpfObjectLabel;
GLAPI PFNGLOBJECTLABELKHR_PROC *glpfObjectLabelKHR;
GLAPI PFNGLOBJECTPTRLABEL_PROC *glpfObjectPtrLabel;
GLAPI PFNGLOBJECTPTRLABELKHR_PROC *glpfObjectPtrLabelKHR;
GLAPI PFNGLPOPDEBUGGROUP_PROC *glpfPopDebugGroup;
GLAPI PFNGLPOPDEBUGGROUPKHR_PROC *glpfPopDebugGroupKHR;
GLAPI PFNGLPUSHDEBUGGROUP_PROC *glpfPushDebugGroup;
GLAPI PFNGLPUSHDEBUGGROUPKHR_PROC *glpfPushDebugGroupKHR;

#define glDebugMessageCallback glpfDebugMessageCallback
#define glDebugMessageCallbackKHR glpfDebugMessageCallbackKHR
#define glDebugMessageControl glpfDebugMessageControl
#define glDebugMessageControlKHR glpfDebugMessageControlKHR
#define glDebugMessageInsert glpfDebugMessageInsert
#define glDebugMessageInsertKHR glpfDebugMessageInsertKHR
#define glGetDebugMessageLog glpfGetDebugMessageLog
#define glGetDebugMessageLogKHR glpfGetDebugMessageLogKHR
#define glGetObjectLabel glpfGetObjectLabel
#define glGetObjectLabelKHR glpfGetObjectLabelKHR
#define glGetObjectPtrLabel glpfGetObjectPtrLabel
#define glGetObjectPtrLabelKHR glpfGetObjectPtrLabelKHR
#define glGetPointerv glpfGetPointerv
#define glGetPointervKHR glpfGetPointervKHR
#define glObjectLabel glpfObjectLabel
#define glObjectLabelKHR glpfObjectLabelKHR
#define glObjectPtrLabel glpfObjectPtrLabel
#define glObjectPtrLabelKHR glpfObjectPtrLabelKHR
#define glPopDebugGroup glpfPopDebugGroup
#define glPopDebugGroupKHR glpfPopDebugGroupKHR
#define glPushDebugGroup glpfPushDebugGroup
#define glPushDebugGroupKHR glpfPushDebugGroupKHR
...
extern int FLEXT_ARB_tesselation_shader;
