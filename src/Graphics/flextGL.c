...
void flextLoadOpenGLFunctions(void)
{
    ...
    glpfDebugMessageCallbackKHR = (PFNGLDEBUGMESSAGECALLBACKKHR_PROC*)get_proc("glDebugMessageCallbackKHR");
    glpfDebugMessageControl = (PFNGLDEBUGMESSAGECONTROL_PROC*)get_proc("glDebugMessageControl");
    glpfDebugMessageControlKHR = (PFNGLDEBUGMESSAGECONTROLKHR_PROC*)get_proc("glDebugMessageControlKHR");
    glpfDebugMessageInsert = (PFNGLDEBUGMESSAGEINSERT_PROC*)get_proc("glDebugMessageInsert");
    glpfDebugMessageInsertKHR = (PFNGLDEBUGMESSAGEINSERTKHR_PROC*)get_proc("glDebugMessageInsertKHR");
    glpfGetDebugMessageLog = (PFNGLGETDEBUGMESSAGELOG_PROC*)get_proc("glGetDebugMessageLog");
    glpfGetDebugMessageLogKHR = (PFNGLGETDEBUGMESSAGELOGKHR_PROC*)get_proc("glGetDebugMessageLogKHR");
    glpfGetObjectLabel = (PFNGLGETOBJECTLABEL_PROC*)get_proc("glGetObjectLabel");
    glpfGetObjectLabelKHR = (PFNGLGETOBJECTLABELKHR_PROC*)get_proc("glGetObjectLabelKHR");
    glpfGetObjectPtrLabel = (PFNGLGETOBJECTPTRLABEL_PROC*)get_proc("glGetObjectPtrLabel");
    glpfGetObjectPtrLabelKHR = (PFNGLGETOBJECTPTRLABELKHR_PROC*)get_proc("glGetObjectPtrLabelKHR");
    glpfGetPointerv = (PFNGLGETPOINTERV_PROC*)get_proc("glGetPointerv");
    glpfGetPointervKHR = (PFNGLGETPOINTERVKHR_PROC*)get_proc("glGetPointervKHR");
    glpfObjectLabel = (PFNGLOBJECTLABEL_PROC*)get_proc("glObjectLabel");
    glpfObjectLabelKHR = (PFNGLOBJECTLABELKHR_PROC*)get_proc("glObjectLabelKHR");
    glpfObjectPtrLabel = (PFNGLOBJECTPTRLABEL_PROC*)get_proc("glObjectPtrLabel");
    glpfObjectPtrLabelKHR = (PFNGLOBJECTPTRLABELKHR_PROC*)get_proc("glObjectPtrLabelKHR");
    glpfPopDebugGroup = (PFNGLPOPDEBUGGROUP_PROC*)get_proc("glPopDebugGroup");
    glpfPopDebugGroupKHR = (PFNGLPOPDEBUGGROUPKHR_PROC*)get_proc("glPopDebugGroupKHR");
    glpfPushDebugGroup = (PFNGLPUSHDEBUGGROUP_PROC*)get_proc("glPushDebugGroup");
    glpfPushDebugGroupKHR = (PFNGLPUSHDEBUGGROUPKHR_PROC*)get_proc("glPushDebugGroupKHR");
...
int FLEXT_ARB_tesselation_shader = GL_FALSE;
...
PFNGLDEBUGMESSAGECALLBACKKHR_PROC* glpfDebugMessageCallbackKHR = NULL;
PFNGLDEBUGMESSAGECONTROL_PROC* glpfDebugMessageControl = NULL;
PFNGLDEBUGMESSAGECONTROLKHR_PROC* glpfDebugMessageControlKHR = NULL;
PFNGLDEBUGMESSAGEINSERT_PROC* glpfDebugMessageInsert = NULL;
PFNGLDEBUGMESSAGEINSERTKHR_PROC* glpfDebugMessageInsertKHR = NULL;
PFNGLGETDEBUGMESSAGELOG_PROC* glpfGetDebugMessageLog = NULL;
PFNGLGETDEBUGMESSAGELOGKHR_PROC* glpfGetDebugMessageLogKHR = NULL;
PFNGLGETOBJECTLABEL_PROC* glpfGetObjectLabel = NULL;
PFNGLGETOBJECTLABELKHR_PROC* glpfGetObjectLabelKHR = NULL;
PFNGLGETOBJECTPTRLABEL_PROC* glpfGetObjectPtrLabel = NULL;
PFNGLGETOBJECTPTRLABELKHR_PROC* glpfGetObjectPtrLabelKHR = NULL;
PFNGLGETPOINTERV_PROC* glpfGetPointerv = NULL;
PFNGLGETPOINTERVKHR_PROC* glpfGetPointervKHR = NULL;
PFNGLOBJECTLABEL_PROC* glpfObjectLabel = NULL;
PFNGLOBJECTLABELKHR_PROC* glpfObjectLabelKHR = NULL;
PFNGLOBJECTPTRLABEL_PROC* glpfObjectPtrLabel = NULL;
PFNGLOBJECTPTRLABELKHR_PROC* glpfObjectPtrLabelKHR = NULL;
PFNGLPOPDEBUGGROUP_PROC* glpfPopDebugGroup = NULL;
PFNGLPOPDEBUGGROUPKHR_PROC* glpfPopDebugGroupKHR = NULL;
PFNGLPUSHDEBUGGROUP_PROC* glpfPushDebugGroup = NULL;
PFNGLPUSHDEBUGGROUPKHR_PROC* glpfPushDebugGroupKHR = NULL;
...
static void add_extension(const char* extension)
{
    ...
    if (strcmp("GL_ARB_tesselation_shader", extension) == 0) {
        FLEXT_ARB_tesselation_shader = GL_TRUE;
    }
}
